      ...
      (
        <div tw="flex flex-col h-full w-full bg-white relative p-20">
          <div tw="flex mb-[1.8rem] w-[1040px]">
            <div
              tw="flex-1 text-[5rem] font-bold overflow-hidden text-[#2f363d]"
          ...
          <div
            tw="text-[#6e7681]"
            style={{ lineHeight: 1.5, fontSize: '33.6px' }}
          >
            저는 피드뱅크를 만들고 있습니다. 간단히 소개하자면 “웹사이트 피드백
            수집툴”로, 작은 소프트웨어를 만드는 제 작은 회사입니다.
          </div>
          ...
          <div tw="absolute bottom-0 w-[1200px] h-6 bg-red-500" />
        </div>
      ),
      {
        width: 1200,
        height: 600,
        fonts: [{ name: 'Pretendard Variable', data: font, style: 'normal' }]
      }
    )
  } catch (e) {
